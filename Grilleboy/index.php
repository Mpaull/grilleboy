...
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
	...
	<input type="text" name="order[]" value="cage-free_eggs" size="1" maxlength="1" onclick="">
	Cage-free Eggs<br />
	style? <input type="text" name="eggs_style" value="style_eggs" size="12" maxlength="15" onclick=""><br />
	...
	<input type="checkbox" name="order[]" value="cheese" onclick="">
	...
	<tr>
	<td>Harvard ID#:</td>
	<td><input name="id" type="password" size="7" maxlength="8"></td>
	</tr>
	<tr>
	<br>
